...
import cs2173.movies.MovieHolder;
...
//                    System.out.println(movie);
            ...
            Logger.getLogger(TestMovieHolder.class.getName()).
        ...
        if (DISLAY_ALL_MOVIES) {
            ...
            if (movieHolder.getAllMovies().isEmpty()) {
                System.out.println(RED + "There are no Movies in the set");
            } else {
                for (Movie movie : movieHolder.getAllMovies()) {
                    System.out.println(movie);
                }
            }
        }//diplay all movies
        ...
        if (SEARCH_BY_TITLE) {
            ...
            //if the set is empty print a message
            if (movieHolder.getAllMoviesByTitle(TITLE) == null) {
                System.out.println(RED + "There are not movies with tilte: " 
                        + TITLE);
            } else {
                for (Movie movie : movieHolder.getAllMoviesByTitle(TITLE)) {
                    System.out.println(movie);
                }
            }
        }//display by title
        ...
        if (SEARCH_BY_YEAR) {
            ...
            //if the set is empty print a message
            if (movieHolder.getAllMoviesByYear(YEAR) == null) {
                System.out.println(RED + "There are not movies in the year: " 
                        + YEAR);
            } else {
                for (Movie movie : movieHolder.getAllMoviesByYear(YEAR)) {
                    System.out.println(movie);
                }
            }
        }//display by year
        ...
        if (SEARCH_BY_GENRE) {
            ...
            //if the set is empty print a message
            if (movieHolder.getAllMoviesByGenre(GENRE) == null) {
                System.out.println(RED + "There are not movies at category: " 
                        + GENRE);
            } else {
                for (Movie movie : movieHolder.getAllMoviesByGenre(GENRE)) {
                    System.out.println(movie);
                }
            }
        }//display by genre
